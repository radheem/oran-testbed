...
class MyXapp(xAppBase):
    def __init__(self, http_server_port, rmr_port):
        ...
        # Publish per-UE KPM values to the metrics pipeline (Kafka by default;
        # consumer writes InfluxDB + MongoDB). Best-effort; never raises.
        self.metrics = get_metrics_writer(measurement="kpm")
        self.ue_dl_tx_data = {}
    ...
    def my_subscription_callback(self, e2_agent_id, subscription_id, indication_hdr, indication_msg, kpm_report_style, ue_id):
        ...
        for ue_id, ue_meas_data in meas_data["ueMeasData"].items():
            ...
            # Report style 4 = per-UE measurements.
            if fields:
                self.metrics.write(fields, tags={"e2_node_id": e2_agent_id, "report_style": 4, "ue_id": ue_id})
