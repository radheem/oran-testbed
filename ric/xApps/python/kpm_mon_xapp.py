...
class MyXapp(xAppBase):
    def __init__(self, config, http_server_port, rmr_port):
        ...
        # Publish KPM values to the metrics pipeline (Kafka by default; the
        # consumer fans out to InfluxDB + MongoDB). METRICS_BACKEND=influx
        # restores direct InfluxDB writes. Best-effort; never raises.
